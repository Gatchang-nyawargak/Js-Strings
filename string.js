...
const food2= food.substring[4] + insertString.substring;
...
//Using JavaScript, find the following words from the following strings:1. "are"const 
//string1 = "The pupils are reading in the library";2. "sitting"const string2 = "The child was sitting on the table before it fell"
